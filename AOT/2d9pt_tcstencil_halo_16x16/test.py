...
tmp_dir = "/root/my_triton/AOT/2d9pt_tcstencil_halo_16x16"
dtype = "fp16"
kernel_path = "/root/my_triton/AOT/2d9pt_tcstencil_halo_16x16/2d9pt_tcstencil_halo_16x16.py"
sig = "*fp16, *fp16, 516, 516, *fp16, *fp16, 2, 16, 16"
kernel_name = "kernel"
grid = "1024, 1, 1"
...
def compile_aot_kernels(dir, kernel_path, sig, name, grid):
...
compile_aot_kernels(tmp_dir, kernel_path, sig, kernel_name,grid)
